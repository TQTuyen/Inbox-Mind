...
export const ERROR_CODE_MAPPING = new Map<string | number, number>([
  ...
  [
    ...
    DB_ERROR_HTTP_STATUS.BAD_REQUEST,
  ],
  ...
  [
    ...
    DB_ERROR_HTTP_STATUS.SERVICE_UNAVAILABLE,
  ],
  [
  ...
  [
    POSTGRES_ERROR_CODES.SYNTAX_ERROR,
  ...
  [
    MYSQL_ERROR_CODES.LOCK_WAIT_TIMEOUT,
    DB_ERROR_HTTP_STATUS.SERVICE_UNAVAILABLE,
  ],
...
export const DB_ERROR_MESSAGES = {
  ...
  SERIALIZATION_FAILURE:
    'Database operation failed due to concurrent modification. Please try again',
  DEADLOCK_DETECTED:
    'Database operation failed due to deadlock. Please try again',
